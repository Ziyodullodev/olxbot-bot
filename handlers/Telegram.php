...
class Telegram
{
    ...
    public function send_media_group($media, $chat_id = null, $disable_notification = false, $protect_content = false, $reply_to_message_id = null, $allow_sending_without_reply = false)
    {
        // Prepare the parameters for sending the media group
        $params = [
            'media' => json_encode($media),
            // Convert the media array to JSON
        ...
        // Make a request to the Telegram Bot API to send the media group
        $this->result = $this->request('sendMediaGroup', $params);
